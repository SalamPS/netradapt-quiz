...
export default function Footer ({children, title}) {
  return (<footer className="bg-[#00312d] text-[#99adab] text-base p-12 md:px-24 md:py-12">
    <div className="flex justify-between items-center border-b border-[#7f9896] py-12 mb-8">
      ...
      <div className="text-[#EAFDE7] text-2xl font-bold">{title}</div>
    </div>
    <div className="text-[#7f9896] grid grid-flow-col grid-cols-1 md:grid-cols-3 mb-8">
      <div>
        ...
        <Link className="block mb-6" href="https://netradapt.com/team">Tim Pengembang</Link>
        <Link className="block mb-6" href="https://netradapt.com/shop">Order Produk</Link>
      </div>
      <div>
